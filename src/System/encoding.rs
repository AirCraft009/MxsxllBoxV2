...
impl CPU {
    pub fn fetch_decode_instruction(&self, addr: u64) -> Instruction {
        ...
        match i_type {
            ILLEGAL => Instruction::new(Opcode::NONE as u8, NOREG as u8, NOREG as u8, 0, i_type),
            Op => Instruction::new(op, NOREG as u8, NOREG as u8, 0, i_type),
            OpReg => {
...
pub fn get_instruction_type(op: u8) -> ITypes {
    match op {
        ...
        x if x == Opcode::ADDI as u8
            ...
            || x == Opcode::RSHIFTI as u8
            || x == Opcode::JUMP as u8
            || x == Opcode::LJUMP as u8 =>
            OpRegImm,
        _ => ILLEGAL,
    }
}
